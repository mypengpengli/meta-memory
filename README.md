...
- 已提供 7 个根领域草案
- 已提供每个根领域下的第一版典型主题清单
- 已把“工作”根领域细化成 `编程 / 产品 / 业务 / 项目 / 工具` 的二级主题树
- 已把“学习”根领域细化成 `方法 / 计划 / 输入 / 训练 / 复盘` 的二级主题树
- 已把“家庭与子女教育”根领域细化成 `理念 / 画像 / 习惯 / 陪伴 / 阶段事项` 的二级主题树
- 已把“日常生活”根领域细化成 `节奏 / 居住 / 饮食 / 事务 / 物品与设备` 的二级主题树
- 已提供“这句话应该放哪”的放置指南
